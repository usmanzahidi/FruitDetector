...
class JSONWriter:
    ...
    def write_instance_predictions_to_json(self, predictions,image_filename="",json_filename="",image_id=0,annList=list(),annotation_id=1):
        """
        ...
        if masks is not None:
            ...
            for segment in masks:
                ...
                annotation_info = pycococreatortools.create_annotation_info(
                    annotation_id, image_id, category_info, segment.mask,
                    image.size, True,tolerance=2)
                annList.append(annotation_info)
                #seg = masks[i].mask
